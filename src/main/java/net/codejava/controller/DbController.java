...
public class DbController {
    ...
    public ResponseEntity<Map<Date, Double>> showData2002(@RequestParam(value = "period", required = false) String period) {
    ...
    public ResponseEntity<Map<Date, Double>> showData4402(@RequestParam(value = "period", required = false) String period) {
        if(period == null) period = "3600";
        dbManager.countWeekTemperatures(Integer.parseInt(period));
